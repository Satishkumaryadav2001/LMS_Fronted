  ...
  async function onLectureDelete(courseId,lectureId){
    ...
    return(
        <HomeLayout>
                              ...
                              <div className="text-center text-2xl font-simibold text-yellow-500">
                                    ...
                                    {/*left section playing videos and displaying course details to admin*/}
                                         ...
                                         <div className="space-y-5 w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black]">
                                           ...
                                           <div>
                                            ...
                                            <p>
                                                <span className="text-yeilow-500 line-clamp-4 ">
                                                   Description: {" "}
                                       ...
                                       {/*right section displaying list of lectures*/}
                                       <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px-black] space-y-4">
