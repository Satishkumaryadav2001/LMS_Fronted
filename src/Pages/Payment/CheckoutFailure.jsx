     ...
     <HomeLayout>
        <div className="min-h-[90vh] flex items-center justify-center text-white">
                      ...
                      <h1 className="bg-red-500 absolute text-center top-0 w-full py-4 text-2xl font-bold rounded-tl-lg rounded-tr-lg">Payment Failed</h1>
                         ...
                         <Link to="/checkout" className="bg-red-500 hover:bg-red-600 transition-all ease-in-out duration-300 absolute bottom-0 w-full py-2 text-xl font-semi-bold text-center rounded-br-lg rounded-bl-lg ">
